...
try:
    ...
    cursor.executemany("INSERT INTO Starborn_Planets (planet_id, planet_name, diameter, distance_from_host, number_of_moons) VALUES (:1, :2, :3, :4, :5)", planets_data)
    ...
    cursor.executemany("INSERT INTO Starborn_Space_Budgets (mission_id, agency_id, budget_amount) VALUES (:1, :2, :3)", budgets_data)
