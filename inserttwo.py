...
try:
    ...
    missions_data = [
        (1, 'Apollo 11', '1969-07-16', 'Moon', 8, 'Completed', 1),
        (2, 'Vostok 1', '1961-04-12', 'Low Earth Orbit', 1, 'Completed', 2),
        (3, 'SpaceX CRS-1', '2012-10-08', 'International Space Station', 23, 'Completed', 1),
        (4, 'Chang\'e 5', '2020-11-23', 'Moon', 23, 'Completed', 3),
        (5, 'Viking 1', '1975-08-20', 'Mars', 6, 'Completed', 4),
        (6, 'Pioneer 10', '1972-03-02', 'Jupiter', 21, 'Completed', 5),
        (7, 'Cassini-Huygens', '1997-10-15', 'Saturn', 20, 'Completed', 6),
        (8, 'New Horizons', '2006-01-19', 'Pluto', 9, 'Completed', 7),
        (9, 'Hubble Space Telescope', '1990-04-24', 'Low Earth Orbit', 31, 'Active', 8),
        (10, 'Apollo 13', '1970-04-11', 'Moon', 6, 'Failed', 9)
    ]
    cursor.executemany("INSERT INTO starborn_Missions (mission_id, mission_name, launch_date, destination, duration, mission_status, spacecraft_id) VALUES (:1, :2, TO_DATE(:3, 'YYYY-MM-DD'), :4, :5, :6, :7)", missions_data)
    ...
    cursor.executemany("INSERT INTO Planets (planet_id, planet_name, diameter, distance_from_sun, number_of_moons) VALUES (:1, :2, :3, :4, :5)", planets_data)

    # Insert data into the Exoplanets table
    exoplanets_data = [
        (1, 'Proxima b', 'Transit', 2016, 4.24, 'Proxima Centauri'),
        (2, 'HD 209458 b', 'Transit', 1999, 153, 'HD 209458'),
        (3, 'Kepler-186f', 'Transit', 2014, 582, 'Kepler-186'),
        (4, 'TRAPPIST-1d', 'Transit', 2017, 39.6, 'TRAPPIST-1'),
        (5, 'Gliese 581g', 'Radial Velocity', 2010, 20.3, 'Gliese 581'),
        (6, 'WASP-121b', 'Transit', 2016, 900, 'WASP-121'),
        (7, 'TOI-700d', 'Transit', 2020, 101.4, 'TOI-700'),
        (8, 'Kepler-22b', 'Transit', 2011, 620, 'Kepler-22'),
        (9, 'GJ 1214 b', 'Transit', 2009, 42.4, 'GJ 1214'),
        (10, '51 Pegasi b', 'Radial Velocity', 1995, 50.9, '51 Pegasi')
    ]
    cursor.executemany("INSERT INTO starborn_Exoplanets (exoplanet_id, exoplanet_name, discovery_method, discovery_year, distance_from_earth, host_star_name) VALUES (:1, :2, :3, :4, :5, :6)", exoplanets_data)
    ...
    space_events_data = [
        (1, 'Mars Rover Landing', '2021-02-18', 'NASA', 'Successful'),
        (2, 'Chandrayaan-2 Mission', '2019-07-22', 'ISRO', 'Partial Success'),
        (3, 'Crew Dragon Demo-2 Launch', '2020-05-30', 'SpaceX', 'Successful'),
        (4, 'Hubble Space Telescope Launch', '1990-04-24', 'NASA', 'Successful'),
        (5, 'Mars InSight Landing', '2018-11-26', 'NASA', 'Successful'),
        (6, 'Voyager 1 Launch', '1977-09-05', 'NASA', 'Successful'),
        (7, 'Apollo 11 Moon Landing', '1969-07-20', 'NASA', 'Successful'),
        (8, 'Sputnik 1 Launch', '1957-10-04', 'Roscosmos', 'Successful'),
        (9, 'Cassini-Huygens Mission', '1997-10-15', 'NASA/ESA', 'Successful'),
        (10, 'SpaceX Starship Test Flight', '2021-12-09', 'SpaceX', 'Successful')
    ]
    ...
    cursor.executemany("INSERT INTO starborn_Space_Exploration_Budgets (mission_id, agency_id, budget_amount) VALUES (:1, :2, :3)", budgets_data)
